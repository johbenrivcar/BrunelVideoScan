...
# SENSITIVITY NOT CURRENTLY IMPLEMENTED:
# scanning.sensitivity should be a number in the range 1 to 10, this is
...
# parameters are:                           V Rectangle V Size    V Anchor point (centre of the rectangle) 
dilationElement = cv2.getStructuringElement(0,          (20, 20), (5, 5))
...
for videoFileName in filesToProcess:
    ...
    while True:
        ...
        thresh = cv2.dilate( thresh, dilationElement )
        ...
        if True: #len(contourList)<50: # Only show rectangles if there are fewer than 50 on the frame
            ...
            for contour in contourList:
                ...
                # on the frame
                box.pixel = pixelMap.bump(rw, cl, outputFrameCount)
